...
@EnableJpaRepositories(basePackages = "br.com.thiagomr.pizzaria.modelo.repositorios")
public class ConfiguracaoBD {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws Exception {
		...
		entityManagerFactoryBean.setPackagesToScan("br.com.thiagomr.pizzaria.modelo.entidades");
